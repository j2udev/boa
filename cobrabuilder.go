...
func (b *CobraCmdBuilder) TraverseChildren(traverse bool) *CobraCmdBuilder {
	b.cmd.TraverseChildren = traverse
	return b
}
...
func (b *CobraCmdBuilder) SilenceErrors(silent bool) *CobraCmdBuilder {
	b.cmd.SilenceErrors = silent
	return b
}

// SilenceUsage is an option to silence usage when an error occurs.
func (b *CobraCmdBuilder) SilenceUsage(silent bool) *CobraCmdBuilder {
	b.cmd.SilenceUsage = silent
	return b
}
...
func (b *CobraCmdBuilder) DisableFlagParsing(disable bool) *CobraCmdBuilder {
	b.cmd.DisableFlagParsing = disable
	return b
}

// DisableAutoGenTag defines, if gen tag ("Auto generated by spf13/cobra...")
// will be printed by generating docs for this command.
func (b *CobraCmdBuilder) DisableAutoGenTag(disable bool) *CobraCmdBuilder {
	b.cmd.DisableAutoGenTag = disable
	return b
}
...
func (b *CobraCmdBuilder) DisableFlagsInUseLine(disable bool) *CobraCmdBuilder {
	b.cmd.DisableFlagsInUseLine = disable
	return b
}

// DisableSuggestions disables the suggestions based on Levenshtein distance
// that go along with 'unknown command' messages.
func (b *CobraCmdBuilder) DisableSuggestions(disable bool) *CobraCmdBuilder {
	b.cmd.DisableSuggestions = disable
	return b
}
